...
const en: SupportLocaleBundle = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Most bookings are charged when the reservation is created. Some hotels allow Pay at Hotel, where your card is only authorized until check-in.",
      category: "payments",
    },
    {
    ...
    },
    {
      ...
      a: "Common reasons are insufficient funds, expired cards, bank security blocks, or incorrect card details. Try another method or contact your bank.",
      category: "payments",
    },
    {
...
const ko: SupportLocaleBundle = {
  ...
  faq: [
    ...
    { q: "숙박 요금은 언제 청구되나요?", a: "대부분의 예약은 예약 생성 시 결제됩니다. 일부 호텔은 현장 결제를 지원하며, 이 경우 체크인 전까지 카드 승인만 진행됩니다.", category: "payments" },
    ...
    { q: "결제가 거절된 이유는 무엇인가요?", a: "잔액 부족, 카드 만료, 은행 보안 차단, 카드 정보 오류 등이 일반적인 원인입니다. 다른 결제 수단을 시도하거나 은행에 문의해 주세요.", category: "payments" },
...
const ru: SupportLocaleBundle = {
  ...
  faq: [
    ...
    { q: "Когда будет списана оплата за проживание?", a: "Большинство бронирований оплачивается при создании. Некоторые отели поддерживают оплату на месте, и до заезда карта только авторизуется.", category: "payments" },
    ...
    { q: "Почему мой платеж был отклонен?", a: "Причиной могут быть недостаток средств, просроченная карта, блокировка банком или неверные данные. Попробуйте другой способ оплаты или свяжитесь с банком.", category: "payments" },
...
const uz: SupportLocaleBundle = {
  ...
  faq: [
    ...
    { q: "Turar joy uchun to'lov qachon olinadi?", a: "Ko'pchilik bronlarda to'lov bron yaratilganda olinadi. Ayrim mehmonxonalar joyida to'lashni qo'llab-quvvatlaydi va bunda karta faqat tasdiqlanadi.", category: "payments" },
    ...
    { q: "Nega to'lovim rad etildi?", a: "Sabablar: mablag' yetishmasligi, kartaning muddati o'tganligi, bank blokirovkasi yoki noto'g'ri karta ma'lumotlari bo'lishi mumkin.", category: "payments" },
