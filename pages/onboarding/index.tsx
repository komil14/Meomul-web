...
const TRAVEL_STYLE_OPTIONS: Array<{ value: TravelStyle; label: string; description: string }> = [
...
const DESTINATION_OPTIONS: Array<{ value: HotelLocation; label: string }> = [
...
const AMENITY_OPTIONS: Array<{ value: string; label: string }> = [
...
const BUDGET_OPTIONS: Array<{ value: BudgetLevel; label: string; range: string }> = [
...
const toggleWithLimit = <T extends string>(current: T[], nextValue: T, limit: number): T[] => {
